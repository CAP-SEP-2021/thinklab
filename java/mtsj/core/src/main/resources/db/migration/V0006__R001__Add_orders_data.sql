INSERT INTO Orders (id, modificationCounter, idBooking, status, idInvitedGuest, idHost) VALUES (0, 1, 0, 'In Bearbeitung', null, 0);
INSERT INTO Orders (id, modificationCounter, idBooking, status, idInvitedGuest, idHost) VALUES (1, 1, 3, 'In Bearbeitung', 0, null);
INSERT INTO Orders (id, modificationCounter, idBooking, status, idInvitedGuest, idHost) VALUES (2, 1, 3, 'In Bearbeitung', 1, null);
INSERT INTO Orders (id, modificationCounter, idBooking, status, idInvitedGuest, idHost) VALUES (3, 1, 3, 'In Bearbeitung', 2, null);
INSERT INTO Orders (id, modificationCounter, idBooking, status, idInvitedGuest, idHost) VALUES (4, 1, 3, 'In Bearbeitung', 3, null);
INSERT INTO Orders (id, modificationCounter, idBooking, status, idInvitedGuest, idHost) VALUES (5, 1, 3, 'In Bearbeitung', 4, null);

INSERT INTO Orders (id, modificationCounter, idBooking, status, idInvitedGuest, idHost) VALUES (6, 1, 4, 'In Bearbeitung', 8, null);
INSERT INTO Orders (id, modificationCounter, idBooking, status, idInvitedGuest, idHost) VALUES (7, 1, 4, 'In Bearbeitung', 9, null);
